...
A variable is like a closet for data values

# 2. Name three (3) operators we've learned about in class and describe 
# a situation where you would use each one. 
3 arithmetic operators we learned about in class are 1Addition, 2Subtraction, and 3Division 1 is a + b, 2 is a - b, and 3 is a / b.
# 3. Describe the difference between camal case and pascal case.
In Camel case the first word is regular and the second word is upper case but in Pascal case every word is upper case.
...
The final varible would be a float.
...
name = input('what is your full government name')
...
It would be writen like 
 The data type that would bvest be useed is a boolean because it could ask if the person has a gluten aleregy true/false.
# 9. In your own words, describe what a program is?
 A program is a set of instructions for the operator.
# 10. Describe the difference between a float and an integer. 
 A float is a decimal number ; while an intiger is a whole number.